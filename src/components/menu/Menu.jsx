    ...
    return (
        <>
            <div onClick={openMenu} className="nav__module__header" ref={buttonRef} onMouseLeave={() => { setX(0), setY(0), cursorOK(22) }} onMouseMove={(e) => { cursorPosition(e) }} onMouseEnter={cursorOO}>
                <button className="nav__module__header__item" style={{ transform: `translate(${x}px, ${y}px)` }}>
            ...
            <div className="nav__module">
                <div onMouseLeave={() => { setDashboardX(0), setDashboardY(0), cursorOK() }} onMouseMove={(e) => { dashboardPosition(e) }} onMouseEnter={cursorOO} ref={dashboardRef} style={{ transform: `translate(${dashboardX}px, ${dashboardY}px)` }} className="nav__item__container" onClick={setActiveTabDashboard}>
                ...
                <div onMouseLeave={() => { setOdatlarX(0), setOdatlarY(0), cursorOK() }} onMouseMove={(e) => { odatlarPosition(e) }} onMouseEnter={cursorOO} ref={odatlarRef} style={{ transform: `translate(${odatlarX}px, ${odatlarY}px)` }} className="nav__item__container" onClick={setActiveTabOdatlar}>
                ...
                <div onMouseLeave={() => { setEslatmalarX(0), setEslatmalarY(0), cursorOK() }} onMouseMove={(e) => { eslatmalarPosition(e) }} onMouseEnter={cursorOO} ref={eslatmalarRef} style={{ transform: `translate(${eslatmalarX}px, ${eslatmalarY}px)` }} className="nav__item__container" onClick={setActiveTabEslatmalar}>
                ...
                <div onMouseLeave={() => { setSozlamalarX(0), setSozlamalarY(0), cursorOK() }} onMouseMove={(e) => { sozlamalarPosition(e) }} onMouseEnter={cursorOO} ref={sozlamalarRef} style={{ transform: `translate(${sozlamalarX}px, ${sozlamalarY}px)` }} className="nav__item__container" onClick={setActiveTabSozlamalar}>
