    ...
    return (
        <>
            <div className="eslatmaContainer">
                <form onSubmit={handleAddeslatma} className="eslatmaForm" style={{ background: `${mode === 'dark' ? '#1c1c1c' : '#ffffff54'}` }}>
                    ...
                    <button type="submit" className="eslatmaButtonContainer" onMouseLeave={() => { cursorOK(), seteSaqlashX(0), seteSaqlashY(0) }} onMouseMove={(e) => { eSaqlashPosition(e) }} onMouseEnter={cursorOO} ref={eSaqlashRef} >
                        <button className="eslatmaButton" style={{ color: `${mode === 'dark' ? '#fff' : '#000'}` }}>Saqlash</button>
                    </button>
                </form>

                <div className="eslatmaList">
                    {eslatmas.map((eslatma) => (
                        <div key={eslatma.id} className="eslatma" style={{ background: `${mode === 'dark' ? '#1c1c1c' : '#ffffff54'}` }}>
